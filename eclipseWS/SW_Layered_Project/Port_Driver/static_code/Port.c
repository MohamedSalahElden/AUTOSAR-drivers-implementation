...
void Port_SetPinMode(Port_PinType Pin, Port_PinModeType Mode){
	...
	if(g_cfgPtr->PinConfig[Pin].PortPinModeChangeable == FALSE){
		Det_ReportError(PORT_MODULE_ID,
				PORT_INSTANCE_ID,
				PORT_SET_PIN_MODE_API_ID,
...
#endif /*for DET error checking*/
	/*not applicable*/
}
#endif /*for function switching*/
